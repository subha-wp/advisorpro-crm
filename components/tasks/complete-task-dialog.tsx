...
export function CompleteTaskDialog({ open, onOpenChange, task, onSuccess }: CompleteTaskDialogProps) {
  ...
  const documentTypes = [
    "ID Proof", "Address Proof", "Income Proof", "Bank Statement", 
    "Medical Reports", "Proposal Form", "Premium Receipt", "Policy Document",
    "Claim Form", "Death Certificate", "Discharge Summary", "Other"
  ]
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const completionData = {
        ...
        clientSatisfaction: form.clientSatisfaction || undefined,
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select value={form.activityOutcome} onValueChange={(value) => setForm(f => ({ ...f, activityOutcome: value }))}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="grid gap-2">
                  ...
                  <Select value={form.clientSatisfaction} onValueChange={(value) => setForm(f => ({ ...f, clientSatisfaction: value }))}>
                    <SelectTrigger>
                ...
                {form.followUpRequired && (
                  <div className="grid grid-cols-2 gap-4 pl-6">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Select value={form.followUpType} onValueChange={(value) => setForm(f => ({ ...f, followUpType: value }))}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
