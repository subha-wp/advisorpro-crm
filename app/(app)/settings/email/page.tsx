...
import { Mail, Key, Building2, CheckCircle, AlertTriangle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Configure your email provider to send professional emails from your own domain
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Enter your API key and from email address above
                </p>
              </div>
            </div>
          </div>
